            ...
            <div className="p-6 bg-zinc-900/80 rounded-2xl border border-gray-800 shadow-2xl backdrop-blur-md flex flex-col gap-5">
              <div className="flex justify-between items-center pb-2 border-b border-gray-800">
                ...
                <div className="px-2 py-0.5 bg-teal-400/10 rounded flex items-center gap-1.5">
                  ...
                  <span className="text-teal-400 text-xs font-bold  ">ACTIVE ENGINE</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2.5">
                <div className="p-3 bg-slate-900/50 rounded-lg border border-gray-800 flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-white text-xs font-semibold  ">Principal Actor</span>
                      <span className="text-slate-400 text-xs font-normal  ">Identity established by authenticated directory session</span>
                    </div>
                  </div>
                  <span className="text-teal-400 text-xs font-normal   truncate max-w-[140px]">
                ...
                <div className="p-3 bg-slate-900/50 rounded-lg border border-gray-800 flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-white text-xs font-semibold  ">Target Resource</span>
                      <span className="text-slate-400 text-xs font-normal  ">Immutable broadcast stream object</span>
                    </div>
                  </div>
                  <span className="text-teal-400 text-xs font-normal   truncate max-w-[140px]">
                ...
                <div className="p-3 bg-slate-900/50 rounded-lg border border-gray-800 flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-white text-xs font-semibold  ">Intended Action</span>
                      <span className="text-slate-400 text-xs font-normal  ">Requires validated cryptographic play-token key</span>
                    </div>
                  </div>
                  <span className="text-teal-400 text-xs font-normal   truncate max-w-[140px]">
                ...
                <div className="p-3 bg-slate-900/50 rounded-lg border border-gray-800 flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-white text-xs font-semibold  ">Applied Policy</span>
                      <span className="text-slate-400 text-xs font-normal  ">Requires OIDC tenant compliance check</span>
                    </div>
                  </div>
                  <span className="text-teal-400 text-xs font-normal   truncate max-w-[140px]">
                ...
                <div className="p-3 bg-slate-900/50 rounded-lg border border-gray-800 flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-white text-xs font-semibold  ">Active Entitlement</span>
                      <span className="text-slate-400 text-xs font-normal  ">Explicit access path granted by administrator</span>
                    </div>
                  </div>
                ...
                <div className="p-3 bg-slate-900/50 rounded-lg border border-gray-800 flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-white text-xs font-semibold  ">Final Decision</span>
                      <span className="text-slate-400 text-xs font-normal  ">Signed with system cryptographic signature</span>
                    </div>
                  </div>
                  <span className="text-teal-400 text-xs font-normal  ">
                    AUTHORIZED (Allow)

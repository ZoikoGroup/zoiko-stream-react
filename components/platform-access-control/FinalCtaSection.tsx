        ...
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link
              ...
              className="px-8 py-4 bg-gradient-to-r from-teal-400 to-blue-500 rounded-lg text-slate-950 text-base font-bold   hover:opacity-90 transition-opacity shadow-lg shadow-black/40"
            >
              Talk to an expert
            </Link>
            <Link
              href="/start-building"
              className="px-8 py-4 rounded-lg border border-slate-300 text-white text-base font-bold   hover:bg-white/10 transition-colors"
            >
              Start building
            </Link>
          </div>

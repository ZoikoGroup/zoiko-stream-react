    ...
    <section className="relative w-full py-16 sm:py-24 bg-white text-zinc-900 border-b border-gray-200 transition-colors duration-250">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col gap-12 sm:gap-16 text-left">
        ...
        <div className="flex flex-col gap-5 max-w-4xl">
          ...
          <p className="text-gray-650 text-base sm:text-lg font-normal font-spaceGrotesk leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {scenarios.map((s, idx) => (
            <div 
              key={idx}
              className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 flex flex-col justify-start items-start gap-5 p-6 hover:-translate-y-1 hover:shadow-md transition-all duration-300"
            >
              ...
              <div className="flex flex-col justify-start items-start gap-3 w-full">
                <div className="flex justify-between items-center w-full">
                  <span className="text-slate-500 text-xs font-bold font-mono tracking-wider">{s.num}</span>
                ...
                <h3 className="text-slate-900 text-xl font-bold font-spaceGrotesk leading-7">
                  {s.title}
                </h3>
                
                <p className="text-slate-550 text-sm font-normal font-spaceGrotesk leading-relaxed text-left">
                  {s.desc}
                </p>
              </div>
            </div>

  ...
  return (
    <section className="relative w-full py-16 sm:py-24 bg-white text-zinc-900 border-b border-gray-200 transition-colors duration-250">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col gap-12 text-left">
        ...
        {/* NOC Panel */}
        <div className="w-full p-6 bg-white rounded-2xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-col justify-start items-start gap-6 shadow-xl">
          
          {/* NOC Toolbar */}
          <div className="w-full border-b border-gray-100 pb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex flex-wrap items-start gap-3 w-full md:w-auto">
              <div className="px-4 py-2 bg-gray-50 rounded-md border border-gray-250/30 text-gray-500 text-sm font-normal font-spaceGrotesk leading-6 w-full sm:w-64 text-left">
                Search session ID or owner...
              </div>
              <div className="px-4 py-2 bg-gray-50 rounded-md border border-gray-250/30 text-slate-900 text-sm font-bold font-spaceGrotesk leading-6 cursor-pointer hover:bg-gray-100">
                Filter: Active Issues (3)
              </div>
            </div>
            <div className="flex items-center gap-3 text-slate-900 text-sm font-bold font-mono tracking-wide shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
            ...
            <div className="flex flex-col justify-start items-start gap-4">
              <h3 className="text-slate-900 text-sm font-bold font-spaceGrotesk leading-6 uppercase tracking-wider">
                TRACK LANES (LIVE NOW)
              </h3>
              
              {/* Lane 1: Track A */}
              <div className="w-full p-5 bg-slate-50 rounded-xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-col justify-start items-start gap-3">
                <div className="w-full flex justify-between items-start">
                  <span className="text-blue-500 text-xs font-bold font-spaceGrotesk">TRACK A</span>
                ...
                <h4 className="text-slate-900 text-base font-bold font-spaceGrotesk leading-tight text-left">
                  Opening Ceremony - Main Stage
                </h4>
                <div className="relative h-10 w-full rounded-sm overflow-hidden bg-slate-100">
                  <Image 
                ...
                <span className="text-slate-600 text-xs font-normal font-spaceGrotesk">
              ...
              <div className="w-full p-5 bg-slate-50 rounded-xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-col justify-start items-start gap-3">
                <div className="w-full flex justify-between items-start">
                  <span className="text-blue-500 text-xs font-bold font-spaceGrotesk">TRACK B</span>
            ...
            <div className="flex flex-col justify-start items-start gap-4">
              ...
              {/* Shift 1 */}
              <div className="w-full p-5 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-col justify-start items-start gap-3 shadow-sm">
                <span className="text-slate-650 text-xs font-bold font-spaceGrotesk">
                  STARTS IN 12 MINS · TRACK A
                </span>
                <h4 className="text-slate-900 text-base font-bold font-spaceGrotesk leading-tight text-left">
                  Keynote Roundtable: The Next 12 Months
                </h4>
                <p className="text-slate-600 text-xs font-normal font-spaceGrotesk leading-relaxed text-left">
                  Speakers: Maya Webb, James Holloway, Ethan Blackwell
                </p>
                <div className="flex items-center gap-1.5 pt-1">
                  {avatars.map((avatar, idx) => (
                    <div key={idx} className="relative size-7 rounded-full border border-white overflow-hidden bg-zinc-800 shadow-sm">
                      <Image 
                        src={avatar} 
                        alt="Speaker Avatar" 
                        fill 
              ...
              <div className="w-full p-5 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-col justify-start items-start gap-3 shadow-sm">
                ...
                <p className="text-slate-655 text-xs font-normal font-spaceGrotesk text-left">

      ...
      <div className="mx-auto flex max-w-4xl flex-col items-start gap-8">
        ...
        <div className="flex w-full flex-col gap-3">
          {ORGANIZATION_PATHS.map((item) => (
            <div
              key={item.code}
              className="group flex flex-col gap-4 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 shadow-sm transition-all hover:border-blue-300 dark:hover:border-blue-500/50 hover:shadow-md sm:flex-row sm:items-center sm:justify-between"
            >
              <div className="flex flex-1 items-start gap-4 sm:items-center">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[10px] border border-gray-200 dark:border-gray-800 bg-slate-100 dark:bg-slate-800 text-base font-bold text-blue-500 dark:text-blue-400">
                  {item.code}
                </div>
              ...
              <Link
                href={item.href}
                className="inline-flex shrink-0 items-center gap-1.5 text-sm font-semibold text-blue-500 dark:text-blue-400 transition-colors group-hover:text-blue-600 dark:group-hover:text-blue-300 sm:self-center"
              >

...
const imgBgDesktop = "/images/company-trust-center/request-evidence-cta-bg-desktop.png";
const imgBgMobile = "/images/company-trust-center/request-evidence-cta-bg-mobile.png";

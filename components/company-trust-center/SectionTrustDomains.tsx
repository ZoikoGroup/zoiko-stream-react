...
const DOMAINS = [
  {
    image: "/images/company-trust-center/domain-security-compliance.png",
    title: "Security & Compliance",
    description: "Controls, assurance and verified framework/report records.",
    cta: "Explore security →",
  },
  {
    image: "/images/company-trust-center/domain-privacy-residency.png",

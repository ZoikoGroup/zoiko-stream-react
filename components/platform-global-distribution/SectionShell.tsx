...
/**
 * Shared frame for every Global Distribution section: full-bleed artwork,
 * the heading pair, then the section's own content.
 */
  ...
  return (
    <section
      ...
      className={`relative isolate w-full scroll-mt-24 ${
        isDark ? 'border-y border-gray-800 bg-slate-900' : 'border-y border-gray-200 bg-white'
      }`}
    >
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        />
        {isDark && <div className="absolute inset-0 bg-slate-900/25" />}
      </div>

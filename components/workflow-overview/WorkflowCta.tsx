...
export default function WorkflowCta({ onStartBrief }: WorkflowCtaProps) {
  return (
    <section 
      id="workflow-cta-band"
      className="relative w-full py-20 sm:py-28 bg-black/75 text-white overflow-hidden border-b border-zinc-900 flex flex-col justify-center items-center text-center"
                          style={{ backgroundImage: "url('/images/workflow-overview/SectionBackground (4).png')" }}
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col justify-center items-center gap-8">
        ...
        {/* Texts */}
        <div className="flex flex-col gap-4 items-center max-w-3xl font-spaceGrotesk">
        ...
        {/* Buttons */}
        <div className="flex flex-wrap items-center justify-center gap-4 w-full sm:w-auto font-spaceGrotesk">
          <button 

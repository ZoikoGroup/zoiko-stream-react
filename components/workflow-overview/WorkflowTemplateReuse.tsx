  ...
  return (
    <section className="relative w-full py-16 sm:py-24 bg-white text-zinc-900 border-b border-gray-200 transition-colors duration-250 font-spaceGrotesk">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col gap-12 text-left">
          ...
          {cards.map((c, idx) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col justify-start items-start gap-2 flex-1">
                <h3 className="text-zinc-955 text-lg font-bold">
                  {c.title}
                </h3>
        ...
        <div className="p-6 bg-slate-55 rounded-xl border border-slate-200 flex flex-col lg:flex-row justify-start items-start lg:items-center gap-8 w-full mt-4">
          ...
          <div className="w-full lg:w-72 flex flex-col gap-2 text-left">
            ...
            <div className="p-3 bg-white rounded-lg border border-emerald-500 flex justify-start items-center gap-2.5">
              <div className="size-2 bg-emerald-555 rounded-full" />
              <span className="text-zinc-955 text-xs font-bold">9 / 9 Gates Approved</span>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col gap-2 text-left w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-205 flex justify-between items-center text-xs">
                <span className="text-zinc-955 font-bold">7 Gates Copied</span>
                <span className="text-emerald-500 font-semibold">✓ Locked</span>
              </div>

              <div className="p-3 bg-white rounded-lg border border-slate-205 flex justify-between items-center text-xs">
                <span className="text-zinc-955 font-bold">Venue Ingest</span>
                <span className="text-amber-500 font-semibold">● Retest Required</span>
              </div>

              <div className="p-3 bg-white rounded-lg border border-slate-205 flex justify-between items-center text-xs">
                <span className="text-zinc-955 font-bold">Stream Authorize</span>

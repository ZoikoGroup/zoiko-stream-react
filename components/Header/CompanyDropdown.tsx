...
const ABOUT_ITEMS: MenuItem[] = [
  { title: 'Company overview', description: 'Who operates ZoikoStream, and why', href: '/company', icon: Layers },
  ...
  { title: 'Zoiko Group', description: 'The parent organization', href: '/company', icon: Building },

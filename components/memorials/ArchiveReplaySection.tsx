  ...
  return (
    <section className="w-full py-16 sm:py-24 bg-zinc-950 text-white transition-colors duration-200 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-12 sm:gap-14">
        ...
        {/* Path steps row */}
        <div className="p-6 sm:p-8 bg-slate-900 rounded-2xl border border-gray-800 flex flex-col sm:flex-row flex-wrap md:flex-nowrap gap-6 sm:gap-4 items-center justify-between">
          
          <div className="flex items-center gap-4">
            <div className="p-4 bg-gray-950 rounded-lg border border-gray-800 text-gray-50 text-sm font-bold">
              Record?
            </div>

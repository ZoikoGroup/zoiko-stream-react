    ...
    <section className="w-full py-16 sm:py-24 bg-white text-zinc-900 transition-colors duration-200 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Card 1: Venue & Source */}
          <div className="bg-slate-50 rounded-xl p-8 shadow-sm border border-slate-200 hover:border-teal-400 transition-colors flex flex-col gap-4">
            <div className="w-9 h-9 bg-zinc-900 rounded-lg flex items-center justify-center text-cyan-405">
              <Video className="w-5 h-5 text-cyan-400" />
            </div>
            <h3 className="text-zinc-900 text-xl font-bold">Venue &amp; source</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
              Where will video and audio come from?
            </p>
            <p className="text-slate-400 text-xs mt-auto pt-2 border-t border-slate-200">
          ...
          <div className="bg-slate-50 rounded-xl p-8 shadow-sm border border-slate-200 hover:border-teal-400 transition-colors flex flex-col gap-4">
            ...
            <h3 className="text-zinc-900 text-xl font-bold">Timing</h3>
            <p className="text-gray-505 text-sm leading-relaxed">
          ...
          <div className="bg-slate-50 rounded-xl p-8 shadow-sm border border-slate-200 hover:border-teal-400 transition-colors flex flex-col gap-4">
            ...
            <h3 className="text-zinc-900 text-xl font-bold">Audience</h3>
            <p className="text-gray-505 text-sm leading-relaxed">
          ...
          <div className="bg-slate-50 rounded-xl p-8 shadow-sm border border-slate-200 hover:border-teal-400 transition-colors flex flex-col gap-4">
            ...
            <h3 className="text-zinc-900 text-xl font-bold">Accessibility</h3>
            <p className="text-gray-505 text-sm leading-relaxed">
          ...
          <div className="bg-slate-50 rounded-xl p-8 shadow-sm border border-slate-200 hover:border-teal-400 transition-colors flex flex-col gap-4">
            ...
            <h3 className="text-zinc-900 text-xl font-bold">Recording &amp; replay</h3>
          ...
          <div className="bg-slate-50 rounded-xl p-8 shadow-sm border border-slate-200 hover:border-teal-400 transition-colors flex flex-col gap-4">
            ...
            <h3 className="text-zinc-900 text-xl font-bold">Support &amp; resilience</h3>
            <p className="text-gray-555 text-sm leading-relaxed">

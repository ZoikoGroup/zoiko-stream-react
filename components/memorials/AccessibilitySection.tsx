    ...
    <section className="w-full py-16 sm:py-24 bg-white dark:bg-gray-900 text-zinc-900 dark:text-white transition-colors duration-200 border-t border-slate-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-12 sm:gap-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Card 1 */}
          <div className="p-8 sm:p-10 bg-slate-50 dark:bg-zinc-955 rounded-2xl border border-teal-400 dark:border-teal-900/40 flex flex-col gap-5">
            <h3 className="text-zinc-900 dark:text-white text-xl font-bold">Captions and languages</h3>
            <p className="text-gray-500 dark:text-slate-350 text-sm sm:text-base leading-relaxed">
          ...
          {/* Card 2 */}
          <div className="p-8 sm:p-10 bg-slate-50 dark:bg-zinc-955 rounded-2xl border border-teal-400 dark:border-teal-900/40 flex flex-col gap-5">
            <h3 className="text-zinc-900 dark:text-white text-xl font-bold">Accessibility &amp; inclusion</h3>
            <p className="text-gray-500 dark:text-slate-350 text-sm sm:text-base leading-relaxed">

    ...
    <section className="w-full py-16 sm:py-24 bg-zinc-900 border-t border-b border-gray-850 text-white transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-12 sm:gap-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Card 1: Venue Source */}
          <div className="p-6 sm:p-8 bg-zinc-950 rounded-xl border border-gray-800 flex flex-col gap-4">
            ...
            <h3 className="text-slate-100 text-xl font-bold">Venue source</h3>
          ...
          <div className="p-6 sm:p-8 bg-zinc-955 rounded-xl border border-gray-800 flex flex-col gap-4">
            <div className="h-40 rounded-lg overflow-hidden flex">
              <img 
                className="w-full h-full object-cover" 
            ...
            <h3 className="text-slate-100 text-xl font-bold">Remote contribution</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <div className="p-6 sm:p-8 bg-zinc-955 rounded-xl border border-gray-800 flex flex-col gap-4">
            ...
            <h3 className="text-slate-100 text-xl font-bold">Production &amp; switching</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
        ...
        <div className="p-6 sm:p-8 bg-zinc-955 rounded-2xl flex flex-col gap-6">
          ...
          <div className="overflow-x-auto w-full scrollbar-none">
            <div className="min-w-[768px] flex flex-col gap-1">
              ...
              <div className="px-4 py-3 bg-slate-800 rounded-t-lg grid grid-cols-4 gap-4">
                ...
                <div className="text-slate-200 text-xs font-bold uppercase tracking-wider">Third party</div>
              </div>

              {/* Rows */}
              <div className="px-4 py-3 bg-gray-900/30 grid grid-cols-4 gap-4 border-b border-gray-800/50">
                <div className="text-slate-300 text-xs font-medium">Venue connectivity</div>
                <div className="text-slate-400 text-xs">Primary owner</div>
                <div className="text-slate-400 text-xs">Support advisory</div>
                <div className="text-slate-400 text-xs">Optional backup</div>
              </div>

              <div className="px-4 py-3 bg-gray-900/30 grid grid-cols-4 gap-4 border-b border-gray-800/50">
                <div className="text-slate-300 text-xs font-medium">Video/audio source</div>
                <div className="text-slate-400 text-xs">AV setup owner</div>
                <div className="text-slate-400 text-xs">Ingest path validation</div>
                <div className="text-slate-400 text-xs">AV contractor (optional)</div>
              </div>

              <div className="px-4 py-3 bg-gray-900/30 grid grid-cols-4 gap-4 border-b border-gray-800/50">
                <div className="text-slate-300 text-xs font-medium">Streaming config</div>
                <div className="text-slate-400 text-xs">Input parameters</div>
                <div className="text-slate-400 text-xs">Core cloud platform</div>
                <div className="text-slate-400 text-xs">Integration helper</div>
              </div>

              <div className="px-4 py-3 bg-gray-900/30 grid grid-cols-4 gap-4 border-b border-gray-800/50">
                <div className="text-slate-305 text-xs font-medium">Audience invitation</div>
                <div className="text-slate-400 text-xs">Primary owner</div>
                <div className="text-slate-400 text-xs">Access control logic</div>
                <div className="text-slate-400 text-xs">N/A</div>
              </div>

              <div className="px-4 py-3 bg-gray-900/30 grid grid-cols-4 gap-4">
                <div className="text-slate-305 text-xs font-medium">Active-event support</div>
                <div className="text-slate-400 text-xs">Local monitor</div>
                <div className="text-slate-400 text-xs">Standard platform SLA</div>
                <div className="text-slate-400 text-xs">Assigned tech expert</div>
              </div>

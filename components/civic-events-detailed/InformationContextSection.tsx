          ...
          <div className="w-full overflow-x-auto">
            <div className="min-w-[800px] flex flex-col gap-2">
              ...
              {rows.map((row, idx) => (
                ...
                >
                  <div className="w-1/4 text-zinc-900 dark:text-white text-sm font-bold font-sans">{row.type}</div>
                  <div className="w-5/12 text-gray-505 dark:text-slate-400 text-sm font-sans leading-relaxed">{row.treatment}</div>
                  <div className="w-1/3 text-gray-500 dark:text-slate-505 text-sm font-sans leading-relaxed">{row.verification}</div>
                </div>
              ))}

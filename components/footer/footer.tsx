...
const ROW_2_SECTIONS: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Contact support', href: '/zoikostream-contact-support' },
      { name: 'Developer support', href: '/zoikostream-developer-support' },
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Trademark guidelines', href: '/zoikostream-trademark' },
    ],
  },
];

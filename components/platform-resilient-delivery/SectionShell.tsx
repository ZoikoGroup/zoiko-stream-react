...
/**
 * Shared frame for every Resilient Delivery section: full-bleed artwork,
  ...
  return (
    <section
      ...
      className={`relative isolate w-full scroll-mt-24 ${
        isDark
          ? 'border-y border-gray-800 bg-slate-950'
    ...
    >
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        />
        {isDark && <div className="absolute inset-0 bg-slate-950/40" />}
      </div>

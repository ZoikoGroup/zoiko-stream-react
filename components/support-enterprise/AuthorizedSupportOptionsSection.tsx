...
const CARDS: AuthOptionCard[] = [
  {
    id: 'available',
    title: 'Available',
    description: 'Submit direct incident briefs to L1 operations engineers immediately.',
    image: '/images/Enterprise Page/se14.png',
  },
  {
    id: 'requires-auth',
    title: 'Requires Authentication',
    description: 'Sign in with corporate SAML to authorize enterprise channels.',
    image: '/images/Enterprise Page/se15.png',
  },
  {
    id: 'temp-unavailable',
    title: 'Temporarily Unavailable',
    description: 'Currently undergoing maintenance. Help Center remains fully active.',
    image: '/images/Enterprise Page/se16.png',
  },
  {
    id: 'not-available',
    title: 'Not Available',
    description: 'Current organization tier requires upgrade to access active support lines.',
    image: '/images/Enterprise Page/se17.png',
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="mb-12">
          <h2 className="text-3xl sm:text-4xl lg:text-[40px] font-bold text-slate-900 tracking-tight mb-3">
            Only current, authorized support options are shown
          </h2>
          <p className="text-slate-500 text-sm sm:text-base max-w-4xl leading-relaxed">
            Support channels scale based on real-time registry validations. We only show paths your organization credentials currently support.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {CARDS.map((card) => (
            ...
            >
              <div>
                {/* Photo Banner */}
                <div className="relative w-full h-40 rounded-xl overflow-hidden mb-4 bg-slate-50 flex items-center justify-center">
                  <Image
                    src={card.image}
                    alt={card.title}
                    fill

...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-zinc-950 px-6 py-14 text-white sm:px-10 lg:px-20 lg:py-20">
      ...
      <div className="relative mx-auto flex max-w-[1240px] flex-col items-center justify-between gap-12 lg:flex-row lg:gap-16">
        <div className="flex w-full flex-col items-start gap-8 lg:w-1/2">
          ...
          <div className="flex flex-col gap-6">
            <h1 className="max-w-[560px]   text-4xl font-bold leading-[1.08] text-slate-100 sm:text-5xl lg:text-5xl">
              Secure video
              <br />
              infrastructure
              <br />
            ...
            <p className="max-w-[520px]   text-base leading-relaxed text-slate-400 sm:text-lg">
        ...
        <div className="flex w-full justify-center lg:w-1/2">
          <div className="flex w-full max-w-[596px] flex-col gap-6 rounded-[20px] border border-gray-800 bg-zinc-900/90 p-5 shadow-2xl sm:p-6">
            <div className="grid grid-cols-3 gap-2 rounded-xl border border-gray-800/60 bg-zinc-950/40 p-1">
              {TAB_OPTIONS.map((tab) => {
            ...
            <div className="aspect-[555/347] overflow-hidden rounded-2xl border border-slate-700/80 bg-zinc-950">
              <Image
            ...
            <div className="flex justify-start pl-1 -mb-9 -mt-9 ">
              <Image
            ...
            <div className="flex flex-col gap-2.5 pt-0.5">
              <div className="flex flex-wrap items-center gap-2.5">
                {FLOW_TAGS_ROW_1.map((tag) => (
                  <div
                    key={tag}
                    className="flex items-center gap-2 rounded-full border border-gray-800 bg-gray-900 px-3 py-2   text-xs font-normal text-slate-400"
                  >
                    <span>{tag}</span>
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                {FLOW_TAGS_ROW_2.map((tag, index) => (
                  ...
                  >
                    <span>{tag}</span>
                    {index < FLOW_TAGS_ROW_2.length - 1 && <span className="text-slate-500">→</span>}
                  </div>
                ))}
              </div>
            </div>

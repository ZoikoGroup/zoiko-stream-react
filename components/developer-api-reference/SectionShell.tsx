...
/**
 * Shared frame for every API Reference section: eyebrow, heading pair,
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-8 sm:py-16 lg:px-16 lg:py-20 xl:px-28">
        ...
        <h2 className="mt-6 max-w-3xl text-2xl font-bold leading-tight text-neutral-700 sm:text-3xl">
          {title}
        </h2>

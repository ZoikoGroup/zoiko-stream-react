      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-12 sm:gap-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {cards.map((card, idx) => (
            <div 
              key={idx}
              className="group relative p-8 bg-slate-50 rounded-xl border border-slate-200 flex flex-col gap-4 hover:shadow-md transition-shadow overflow-hidden"
            >
              ...
              <h3 className="relative z-10 text-white text-xl font-bold font-sans">
                {card.title}
              </h3>

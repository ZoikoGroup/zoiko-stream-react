      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-12 sm:gap-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((card, idx) => (
            <div 
              key={idx}
              className="group relative h-60 rounded-xl overflow-hidden shadow-md border border-slate-200 flex flex-col justify-end p-6 hover:shadow-lg transition-all duration-300"
            >

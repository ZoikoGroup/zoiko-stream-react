...
export default function HeroSection() {
  return (
    <section className="w-full bg-slate-950 bg-radial-[at_82%_8%] from-violet-500/20 via-slate-950 to-slate-950 px-4 py-12 md:px-12 lg:px-20 lg:py-16  dark:bg-gray dark:text-white">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-10 lg:flex-row lg:gap-12">
        <div className="flex w-full flex-col items-start gap-4 lg:max-w-[620px]">
          ...
          <h1 className="  text-4xl font-semibold leading-tight text-slate-100 sm:text-5xl md:text-5xl md:leading-[1.1]">
          ...
          <p className="mt-2   text-base font-normal leading-relaxed text-slate-400 sm:text-lg">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3.5">
            <Link
              href="/signup"
              className="inline-flex min-h-[48px] items-center justify-center rounded-[10px] bg-gradient-to-r from-teal-400 to-blue-500 px-6 py-3.5   text-base font-medium text-slate-950 transition-opacity hover:opacity-95"
            >
              Start building
            </Link>
            ...
            <Link
              href="/contact"
              className="inline-flex min-h-[48px] items-center justify-center rounded-[10px] border border-slate-700 px-6 py-3.5   text-base font-medium text-white transition-colors hover:bg-slate-800/50"
            >
              Talk to an expert
            </Link>
          </div>

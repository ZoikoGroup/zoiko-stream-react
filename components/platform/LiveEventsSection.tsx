  ...
  return (
    <section className="w-full bg-slate-100 px-4 py-16 md:px-12 lg:px-20 lg:py-28">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-12 lg:flex-row lg:gap-16">
        <div className="flex w-full flex-1 flex-col items-start gap-4">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 py-2">
            {EVENT_CAPABILITIES.map((capability) => (
              <span key={capability} className="font-['Space_Grotesk'] text-sm font-normal text-gray-500">
                {capability}
              </span>
            ))}
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3.5 pt-2">
            <Link
              href="/plan-event"
              className="inline-flex min-h-[48px] items-center justify-center rounded-[10px] bg-gradient-to-r from-teal-400 to-blue-500 px-6 py-3.5 font-['Space_Grotesk'] text-base font-normal text-slate-950 transition-opacity hover:opacity-95"
            >
              Plan a live event
            </Link>
            ...
            <Link
              href="/contact-expert"
              className="inline-flex min-h-[48px] items-center justify-center rounded-[10px] border border-gray-800 px-6 py-3.5 font-['Space_Grotesk'] text-base font-normal text-zinc-900 transition-colors hover:bg-gray-200"
            >
              Talk to an expert
            </Link>
          </div>

          <div className="pt-2 font-['Space_Grotesk'] text-xs text-gray-500">
            Full detail remains on the{' '}
            <Link href="/live-events" className="inline-flex items-center gap-1 font-['Inter'] font-semibold text-blue-500 hover:underline">
        ...
        <div className="relative w-full flex-1 overflow-hidden rounded-2xl border border-neutral-300 ">

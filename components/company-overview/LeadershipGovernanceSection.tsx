  ...
  return (
    <section className="w-full bg-slate-50 px-6 py-16 text-gray-900 sm:px-12 lg:px-20 lg:py-24">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Feature Card Layout */}
        <div className="overflow-hidden rounded-3xl bg-white border border-transparent shadow-[0px_14px_34px_-14px_rgba(16,24,40,0.14)]">
          <div className="grid grid-cols-1 items-stretch lg:grid-cols-12">
            ...
            <div className="flex flex-col justify-center p-8 sm:p-10 lg:col-span-7 lg:p-12">
              ...
              {/* Card Title */}
              <h3 className="mb-3.5 text-xl font-bold text-gray-900 sm:text-2xl">
                Leadership directory
              </h3>

              {/* Card Description */}
              <p className="mb-6 text-base font-normal leading-relaxed text-slate-500">
              ...
              <div className="mb-8 flex flex-col border-t border-slate-200">
                {GOVERNANCE_LINKS.map((link) => (
                  <Link
                    key={link.label}
                    href={link.href}
                    className="group flex items-center justify-between border-b border-slate-200 py-3.5 transition-colors hover:bg-slate-50/50"
                  >
                    <span className="text-sm font-medium text-gray-900 transition-colors group-hover:text-violet-600">
                      {link.label}
                    </span>
                    <span className="text-sm font-bold text-violet-500 transition-transform group-hover:translate-x-1">
                      →
                    </span>
                  </Link>
                ))}
              ...
              <div>
                <Link
                  href="/leadership"
                  className="inline-flex items-center justify-center rounded-[10px] border border-slate-200 px-5 py-3 text-sm font-medium text-gray-900 transition-all hover:border-slate-400 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500"
                >

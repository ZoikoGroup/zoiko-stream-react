...
export default function BroadcastCalloutBanner({
  ...
  return (
    <section className="relative w-full overflow-hidden bg-slate-950 py-16 sm:py-20 lg:py-24">
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center justify-center px-6 text-center sm:px-8">
        <div className="flex max-w-2xl flex-col items-center gap-3">
          {/* Main Title */}
          <h2 className="  text-2xl font-bold leading-snug text-white sm:text-3xl sm:leading-tight lg:text-4xl">
            {title}
          </h2>

          {/* Subtitle */}
          <p className="  text-sm font-normal leading-relaxed text-white/70 sm:text-base">
            {subtitle}
          </p>
        </div>
      </div>

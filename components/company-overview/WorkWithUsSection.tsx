          ...
          {PATHWAYS.map((item) => (
            ...
            >
              <div className="flex flex-col items-start gap-4">
                {/* Number Badge */}
                <div className="inline-flex h-9 min-w-9 items-center justify-center rounded-lg bg-gray-950 px-2.5">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className="  text-xs font-normal leading-relaxed text-slate-500 sm:text-xs">
                    {item.description}
                  </p>
                </div>
              </div>

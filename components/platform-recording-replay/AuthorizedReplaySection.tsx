          ...
          <div className="p-6 bg-zinc-900 text-white rounded-2xl border border-gray-800 shadow-xl flex flex-col justify-between gap-5">
            ...
            <div className="flex flex-col gap-3">
              <div className="pb-2 border-b border-gray-800/80 flex justify-between items-center">
                <span className="text-slate-400 text-sm font-['Space_Grotesk']">Media integrity</span>
                <span className="px-2.5 py-1 bg-emerald-950 rounded text-teal-400 text-xs font-bold font-['Space_Grotesk'] flex items-center gap-1">
                  Ready <Check className="size-3" />
                </span>
              </div>

              <div className="pb-2 border-b border-gray-800/80 flex justify-between items-center">
                <span className="text-slate-400 text-sm font-['Space_Grotesk']">Metadata</span>
                <span className="px-2.5 py-1 bg-emerald-950 rounded text-teal-400 text-xs font-bold font-['Space_Grotesk'] flex items-center gap-1">
              ...
              <div className="pb-2 border-b border-gray-800/80 flex justify-between items-center">
                ...
                <span className="px-2.5 py-1 bg-amber-950 rounded text-amber-500 text-xs font-bold font-['Space_Grotesk'] flex items-center gap-1">
                  Needs review <AlertTriangle className="size-3" />
                </span>
              </div>

              <div className="pb-2 border-b border-gray-800/80 flex justify-between items-center">
                <span className="text-slate-400 text-sm font-['Space_Grotesk']">Accessibility/language</span>
                <span className="px-2.5 py-1 bg-blue-950 rounded text-blue-400 text-xs font-bold font-['Space_Grotesk'] flex items-center gap-1">
                  In preparation <PieChart className="size-3" />
                </span>
              </div>

              <div className="pb-2 border-b border-gray-800/80 flex justify-between items-center">
                <span className="text-slate-400 text-sm font-['Space_Grotesk']">Corrections</span>
                <span className="px-2.5 py-1 bg-emerald-950 rounded text-teal-400 text-xs font-bold font-['Space_Grotesk'] flex items-center gap-1">
              ...
              <div className="pb-2 border-b border-gray-800/80 flex justify-between items-center">
                <span className="text-slate-400 text-sm font-['Space_Grotesk']">Audience/access</span>
                <span className="px-2.5 py-1 bg-emerald-950 rounded text-teal-400 text-xs font-bold font-['Space_Grotesk'] flex items-center gap-1">
              ...
              <div className="pb-2 border-b border-gray-800/80 flex justify-between items-center">
                <span className="text-slate-400 text-sm font-['Space_Grotesk']">Playback policy</span>
                <span className="px-2.5 py-1 bg-emerald-950 rounded text-teal-400 text-xs font-bold font-['Space_Grotesk'] flex items-center gap-1">
              ...
              <div className="pb-2 border-b border-gray-800/80 flex justify-between items-center">
                <span className="text-slate-400 text-sm font-['Space_Grotesk']">Lifecycle/expiry</span>
                <span className="px-2.5 py-1 bg-emerald-950 rounded text-teal-400 text-xs font-bold font-['Space_Grotesk'] flex items-center gap-1">
            ...
            <div className="pt-2 text-center text-slate-400 text-xs font-['Space_Grotesk'] border-t border-gray-800">
          ...
          <div className="p-6 bg-zinc-900 text-white rounded-2xl border border-gray-800 shadow-xl flex flex-col justify-between gap-5">
            <div className="flex justify-between items-center pb-3 border-b border-gray-800">
              ...
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 bg-emerald-950 rounded text-teal-400 text-xs font-bold font-['Space_Grotesk']">
                  Available
                </span>
                <span className="px-2 py-0.5 bg-blue-950 rounded text-blue-400 text-xs font-bold font-['Space_Grotesk']">
                  Authorized
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <div className="flex-1 flex flex-col gap-2.5">
                ...
                <ul className="text-slate-400 text-xs font-normal font-['Space_Grotesk'] space-y-1">

        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 bg-zinc-900/90 rounded-2xl border border-gray-800 backdrop-blur-md flex flex-col justify-between gap-6">
            ...
            <Link
              ...
              className="w-full py-3.5 bg-gradient-to-r from-teal-400 to-blue-500 rounded-lg text-slate-950 text-center text-sm font-bold   hover:opacity-90 transition-opacity"
            >
              Talk to an expert
            </Link>
          </div>
          ...
          <div className="p-8 bg-zinc-900/90 rounded-2xl border border-gray-800 backdrop-blur-md flex flex-col justify-between gap-6">
            ...
            <Link
              href="/start-building"
              className="w-full py-3.5 border border-slate-400 rounded-lg text-white text-center text-sm font-bold   hover:bg-white/10 transition-colors"
            >
              Start building
            </Link>
          </div>

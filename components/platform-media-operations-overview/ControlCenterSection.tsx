...
export default function ControlCenterSection() {
  return (
    <section
      className="relative bg-white w-full px-4 sm:px-8 lg:px-28 py-16 sm:py-20 lg:py-24 border-b border-gray-200 flex flex-col gap-14 overflow-hidden min-h-[742px]"
    >
      ...
      {/* Console UI */}
      <div className="relative z-10 w-full bg-white rounded-2xl border border-gray-200 shadow-2xl flex flex-col overflow-hidden">
        {/* Title bar */}

const row1 = [
  { title: 'Operating Model', desc: 'Roles, readiness, state, evidence, escalation.' },
  { title: 'Security & Access', desc: 'Scoped access, security/privacy boundaries.' },
  { title: 'Reliability', desc: 'Approved resilience/status evidence with scope.' },
  { title: 'Monitoring & Support', desc: 'Status/support distinction and pathways.' },
];

const row2 = [
  { title: 'Accessibility', desc: 'WCAG 2.2 AA + product accessibility boundaries.' },
  { title: 'Privacy', desc: 'Data minimization, analytics exclusions.' },
  { title: 'Change Management', desc: 'Claim freshness, changelog, deprecation.' },
  { title: 'Commercial', desc: 'Pricing and enterprise consultation routes.' },
];
      ...
      <div className="flex flex-col gap-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {row1.map((item) => (
            ...
            >
              <span className="w-5 h-5 border-2 border-blue-500 rounded-sm" />

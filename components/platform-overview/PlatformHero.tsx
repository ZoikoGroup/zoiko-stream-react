...
export default function PlatformHero() {
  ...
  return (
    <section className="relative w-full py-20 sm:py-28  text-zinc-900 overflow-hidden border-b border-slate-200 font-spaceGrotesk">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row justify-between items-center gap-12 text-left">
        ...
        <div className="flex-1 flex flex-col justify-start items-start gap-6 max-w-xl">
          <div className="px-3 py-1.5 rounded-full outline outline-1 outline-offset-[-1px] outline-teal-400 inline-flex items-center gap-2 bg-teal-500/10">
            ...
            <span className="text-[#34D4CA] text-xs font-bold uppercase tracking-wide">
              ONE PLATFORM
            </span>
          </div>

          <h1 className="text-white text-5xl sm:text-5xl font-bold leading-[1.1] tracking-tight">
            Secure media infrastructure for the complete video lifecycle.
          </h1>

          <p className="text-[#AAB3C4] text-base sm:text-lg font-normal leading-relaxed">
        ...
        <div className="w-full lg:w-[500px] p-8 bg-black rounded-2xl border border-base flex flex-col gap-6 shadow-md">
          ...
          <div className="flex flex-col gap-4 w-full text-xs">
            <div className="flex justify-between items-center w-full">
              <span className="text-slate-500">Source Signal</span>
              <span className="text-teal-500 font-bold">SRT Ingest (Stable)</span>
            </div>
            <div className="flex justify-between items-center w-full">
              <span className="text-slate-500">Processing Nodes</span>
              <span className="text-teal-600 font-bold">Transcoding Active</span>
            </div>
            <div className="flex justify-between items-center w-full">
              <span className="text-slate-500">Delivery Network</span>
              <span className="text-teal-600 font-bold">99.99% Node Integrity</span>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center w-full">
            ...
            <span className="px-2 py-1 bg-teal-500/10 text-teal-500 text-xs font-bold rounded-sm tracking-wider">
              ONLINE
            </span>
          </div>
        </div>

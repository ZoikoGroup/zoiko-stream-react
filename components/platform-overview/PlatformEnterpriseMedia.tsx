    ...
    <section className="relative w-full py-16 sm:py-24 bg-white text-zinc-900 border-b border-gray-200 transition-colors duration-250 font-spaceGrotesk">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col gap-12 text-left">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-12 w-full">
          ...
          <div className="w-full lg:w-[500px] p-6 bg-slate-50 rounded-2xl border border-gray-200 flex flex-col gap-4 shadow-sm shrink-0">
            ...
            <div className="flex flex-col gap-2.5 w-full">
              {feeds.map((feed, idx) => (
                <div 
                  key={idx}
                  className="p-3.5 bg-white rounded-lg border border-gray-150 flex justify-between items-center text-sm font-spaceGrotesk"
                >
                  <span className="text-zinc-955 font-medium">{feed.name}</span>
          ...
          <div className="flex-1 flex flex-col justify-start items-start gap-6 max-w-xl">
            <h3 className="text-zinc-955 text-2xl sm:text-3xl font-bold leading-tight">

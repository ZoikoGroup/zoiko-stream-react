...
export default function RequestEnterpriseQuoteFormSection() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const ref = `ZS-REQ-${Math.floor(100000 + Math.random() * 900000)}`;
      setReferenceId(ref);
      setStatus('success');
    } catch (err) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-10 flex flex-col gap-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-zinc-900 text-xl font-bold font-['Space_Grotesk']">
            ...
            {status === 'success' ? (
              <div className="flex flex-col items-center justify-center py-12 text-center gap-6">
                ...
                <p className="text-slate-600 text-base max-w-md font-normal font-['Inter'] leading-relaxed">
                  Thank you! Our technical experts are reviewing your details and will get back to you shortly.
                </p>
                <button
                  type="button"
                  onClick={handleReset}
                  className="px-8 py-3.5 bg-gradient-to-r from-teal-400 to-blue-500 rounded-lg text-slate-950 font-bold font-['Inter'] hover:opacity-90 transition-opacity"
                >
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="flex flex-col gap-2">
                    <label className="text-zinc-900 text-sm font-semibold font-['Inter']">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-white rounded-lg border text-sm font-['Inter'] focus:outline-none ${
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white rounded-lg border border-gray-300 text-sm font-['Inter'] focus:outline-none"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="flex flex-col gap-2">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 bg-white rounded-lg border text-sm font-['Inter'] focus:outline-none cursor-pointer ${
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 bg-white rounded-lg border text-sm font-['Inter'] focus:outline-none resize-none ${
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-gradient-to-r from-teal-400 to-blue-500 rounded-lg text-slate-950 font-bold font-['Inter'] text-base flex items-center justify-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-50 cursor-pointer shadow-md"
                >
                  {status === 'submitting' ? (
                    <>
                ...
                <div className="p-4 bg-slate-100 rounded-xl border border-gray-200 flex items-start gap-3">
                  ...
                  <p className="text-gray-600 text-xs font-normal font-['Inter'] leading-relaxed">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <h3 className="text-zinc-900 text-base font-bold font-['Inter']">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <h4 className="text-zinc-900 text-sm font-bold font-['Space_Grotesk'] group-hover:text-teal-600 transition-colors">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <h4 className="text-zinc-900 text-sm font-bold font-['Space_Grotesk'] group-hover:text-blue-600 transition-colors">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <h4 className="text-zinc-900 text-sm font-bold font-['Space_Grotesk'] group-hover:text-violet-600 transition-colors">
            ...
            <div className="p-6 bg-slate-100 rounded-2xl border border-gray-200 flex flex-col gap-5">
              <h4 className="text-zinc-900 text-sm font-bold font-['Space_Grotesk']">
              ...
              <div className="flex flex-col gap-3.5">
                ...
                <div className="flex items-center gap-3">
                  <Radio className="size-4 text-slate-600 shrink-0" />
                  <span className="text-gray-600 text-xs font-normal font-['Inter']">

...
import bg11 from '@/public/images/resources-changelog/section-11bg.png';

export default function ChangelogMigrationCtaSection() {
  return (
    <section className="relative w-full px-4 sm:px-8 lg:px-28 py-16 lg:py-28 bg-gray-950/90 border-b border-gray-800 flex flex-col justify-center items-center gap-10 overflow-hidden text-center">
      {/* Background Image */}
      <div className="absolute inset-0 pointer-events-none z-0">
        <Image
          src={bg11}
          alt="Migration CTA Background"
          fill
      ...
      <div className="relative z-10 w-full max-w-3xl flex flex-col justify-start items-center gap-4">
        <h2 className="text-white text-3xl sm:text-4xl lg:text-4xl font-bold font-['Space_Grotesk'] leading-tight lg:leading-[56px]">
          Need managed migration support?
        </h2>
        <p className="text-slate-400 text-base sm:text-lg font-normal font-['Inter'] leading-relaxed sm:leading-7">
          For enterprise teams requiring guided architecture changes, dedicated migration paths, or managed operational transitions.
        </p>
      </div>
      ...
      <span className="relative z-10 text-slate-500 text-xm font-normal font-['Inter']">
        No sales gate for change information. Full access is natively public under open protocol governance.
      </span>
    </section>
  );
}

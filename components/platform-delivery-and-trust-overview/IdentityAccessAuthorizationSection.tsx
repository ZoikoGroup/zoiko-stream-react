        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="p-7 bg-slate-50 rounded-2xl border border-slate-200 flex flex-col gap-5 shadow-sm">
              <h3 className="text-gray-950 text-sm font-bold font-['Space_Grotesk'] tracking-wide uppercase">
                ...
                {evaluationRows.map((row, idx) => (
                  ...
                  >
                    <div className="flex flex-col">
                      <span className="text-gray-950 text-sm font-bold font-['Inter']">
                        {row.state}
                      </span>
                    ...
                    <span className={`px-2.5 py-1 rounded text-xs font-bold font-['Inter'] ${row.badgeClass}`}>
                      {row.badge}
                    </span>
                  </div>
                ))}
